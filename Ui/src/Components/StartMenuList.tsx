...
function StartMenuList({
 ...
 const context = useContext(bgthemeContext);
    ...
    const RemoveWorkspaceStar = async (email: string, SpaceId: string) => {
        try {
            setapiloading(true)
            setapiloading(true)
            const response = await instance.put("/api/Workspace/Remove-WorkspaceStar", { SpaceId, email })
                        ...
                        star.map((itm: any, idx: number) => (
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    "
                                        onClick={() => RemoveWorkspaceStar(useremail, itm.workspaceID)}
                                    >
                                        <FiStar
